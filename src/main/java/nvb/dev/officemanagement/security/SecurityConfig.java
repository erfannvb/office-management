    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, MANAGER_URL).hasAnyRole(ADMIN_WRITE.getPermission())
                        .requestMatchers(HttpMethod.POST, MANAGER_URL).hasAnyRole(ADMIN_WRITE.getPermission())
                        .requestMatchers(HttpMethod.PUT, MANAGER_URL).hasAnyRole(ADMIN_WRITE.getPermission())
                        .requestMatchers(HttpMethod.PATCH, MANAGER_URL).hasAnyRole(ADMIN_WRITE.getPermission())
